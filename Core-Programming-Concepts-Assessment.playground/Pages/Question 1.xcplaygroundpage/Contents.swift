...
let tempCelcuis : Double = 20
let tempFahrenheit = tempCelcuis * 9 / 5 + 32
print("A temperature in degrees Celsius of \(tempCelcuis) is equal to \(tempFahrenheit) in degrees Fahrenheit.")
